      ...
      <div class="form-input">
                       ...
                       if(isset($_POST["save"])){
                          ...
                          if (editPaketPC($_POST) > 0) {
                              ...
                              echo "<div class=\"alert alert-danger alert-dismissible fade show\" role=\"alert\">
                                  <strong>Gagal!</strong> Data gagal diubah, cek ulang!!
        ...
        <table class="table-group" id="form" cellpadding="4" align="center" border="0" width="100%">
          <?php
            ...
            $data_pc = tampil_data("SELECT * FROM paket_pc WHERE ID_PC = '$id'")[0];
            //var_dump($data_pc);
           ?>
          <tr>
            <td width="10%">
                ...
                <div class="input-group mb-1">
                  <input type="hidden" name="id_pc" value="<?=$data_pc["ID_PC"]; ?>">
                    <input type="text" class="form-control" name="proc" placeholder="" value="<?=$data_pc["PROC"]; ?>" autofocus>
          ...
          <tr>
            <td width="48%">
              ...
              <div class="input-group mb-1">
                  <input type="text" class="form-control" name="mobo" placeholder="" value="<?=$data_pc["MOBO"]; ?>" autofocus>
                  <div class="input-group-prepend">
                    <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#myModal" onclick="refresh()"><i class="fas fa-search"></i></button>
                  </div>
              </div>
          ...
          <tr>
            <td>
              <div class="form-group">
                ...
                <div class="input-group mb-1">
                    <input type="text" class="form-control" name="ram" placeholder="" value="<?=$data_pc["RAM"]; ?>" autofocus>
                    <div class="input-group-prepend">
                      <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#myModal" onclick="refresh()"><i class="fas fa-search"></i></button>
                    </div>
                </div>
          ...
          <tr>
            <td width="10%">
              <div class="form-group">
                ...
                <div class="input-group mb-1">
                    <input type="text" class="form-control" name="hdd" placeholder="" value="<?=$data_pc["HDD"]; ?>" autofocus>
                    <div class="input-group-prepend">
                      <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#myModal" onclick="refresh()"><i class="fas fa-search"></i></button>
                    </div>
                </div>
          ...
          <tr>
            <td>
              <div class="form-group">
                ...
                <div class="input-group mb-1">
                    <input type="text" class="form-control" name="ssd" placeholder="" value="<?=$data_pc["SSD"]; ?>" autofocus>
                    <div class="input-group-prepend">
                      <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#myModal" onclick="refresh()"><i class="fas fa-search"></i></button>
                    </div>
                </div>
          ...
          <tr>
            <td>
              <div class="form-group">
                ...
                <div class="input-group mb-1">
                    <input type="text" class="form-control" name="vga" placeholder="" value="<?=$data_pc["VGA"]; ?>" autofocus>
                    <div class="input-group-prepend">
                      <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#myModal" onclick="refresh()"><i class="fas fa-search"></i></button>
                    </div>
                </div>
          ...
          <tr>
            <td>
              <div class="form-group">
                ...
                <div class="input-group mb-1">
                    <input type="text" class="form-control" name="psu" placeholder="" value="<?=$data_pc["PSU"]; ?>" autofocus>
                    <div class="input-group-prepend">
                      <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#myModal" onclick="refresh()"><i class="fas fa-search"></i></button>
                    </div>
                </div>
          ...
          <tr>
            <td>
              <div class="form-group">
                ...
                <div class="input-group mb-1">
                    <input type="text" class="form-control" name="casing" placeholder="" value="<?=$data_pc["CASING"]; ?>" autofocus>
                    <div class="input-group-prepend">
                      <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#myModal" onclick="refresh()"><i class="fas fa-search"></i></button>
                    </div>
                </div>
          ...
          <tr>
            <td>
              <div class="form-group">
                ...
                <div class="input-group mb-1">
                    <input type="text" class="form-control" name="monitor" placeholder="" value="<?=$data_pc["MONITOR"]; ?>" autofocus>
                    <div class="input-group-prepend">
                      <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#myModal" onclick="refresh()"><i class="fas fa-search"></i></button>
                    </div>
                </div>
          ...
          <tr>
            <td>
              <div class="form-group">
                ...
                <div class="input-group mb-1">
                    <input type="text" class="form-control" name="keyb" placeholder="" value="<?=$data_pc["KEYB"]; ?>" autofocus>
                    <div class="input-group-prepend">
                      <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#myModal" onclick="refresh()"><i class="fas fa-search"></i></button>
                    </div>
                </div>
          ...
          <tr>
            <td>
              <div class="form-group">
                ...
                <div class="input-group mb-1">
                    <input type="text" class="form-control" name="mouse" placeholder="" value="<?=$data_pc["MOUSE"]; ?>" autofocus>
                    <div class="input-group-prepend">
                      <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#myModal" onclick="refresh()"><i class="fas fa-search"></i></button>
                    </div>
                </div>
          ...
          <tr>
            <td>
              <div class="form-group">
                ...
                <div class="input-group mb-1">
                    <input type="text" class="form-control" name="speaker" placeholder="" value="<?=$data_pc["SPEAK"]; ?>" autofocus>
                    <div class="input-group-prepend">
                      <button class="btn btn-primary" type="button" data-toggle="modal" data-target="#myModal" onclick="refresh()"><i class="fas fa-search"></i></button>
                    </div>
                </div>
          ...
          <tr>
            <td>
              <div class="form-group">
                ...
                <div class="input-group mb-1">
                    <input type="text" class="form-control" name="hargapc" placeholder="" value="<?=$data_pc["HARGA_PC"]; ?>" autofocus>
                </div>
              </div>
            </td>
          </tr>
